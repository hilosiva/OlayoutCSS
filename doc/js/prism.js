/* PrismJS 1.28.0
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript&plugins=show-invisibles+show-language+toolbar+copy-to-clipboard */
  ...
  if ("undefined" != typeof Prism && "undefined" != typeof document) {
    ...
    a("label", function (e) {
      ...
      if (t && /pre/i.test(t.nodeName) && t.hasAttribute("data-label")) {
        ...
        return (
          a ? (n = a.content) : (t.hasAttribute("data-url") ? ((n = document.createElement("a")).href = t.getAttribute("data-url")) : (n = document.createElement("span")), (n.textContent = r)), n
        );
      }
    }),
